...
def main():
    ...
    # better_draw_circles(rg.Point(200, 50), 8)
    # better_draw_circles(rg.Point(-400, 60), 8)

    # even_better_draw_circles(rg.Point(-400, 0), 5, 15, 'red', 3)
    # even_better_draw_circles(rg.Point(-400, 200), 7, 18, 'purple', 4)
    # even_better_draw_circles(rg. Point (400, 0), 9, 20, 'yellow', 5)
    # even_better_draw_circles(rg.Point(400, 200), 11, 23, 'orange', 6)

    awesome_ricardo_circles(rg.Point(-300, 100), 7, 20, 'red', 3)
    awesome_ricardo_circles(rg.Point(-300, -200), 8, 20, 'orange', 4)
    awesome_ricardo_circles(rg.Point(300, 100), 9, 20, 'yellow', 5)
    awesome_ricardo_circles(rg.Point(300, -200), 10, 20, 'purple', 6)
    awesome_ricardo_circles(rg.Point(0, 0), 11, 30, 'blue', 7)
...
def even_better_draw_circles(point, radius_change, number_of_circles, pen_color, pen_thickness):
    turtle = rg.SimpleTurtle()
...
def awesome_ricardo_circles(point, radius_difference, num_of_circles, pen_color, pen_thick):
    ricardo = rg.SimpleTurtle()
    ricardo.pen = rg.Pen(pen_color, pen_thick)
    ricardo.pen_up()
    ricardo.go_to(point)
    ricardo.set_heading(0)

    for x in range(1, num_of_circles):
        ricardo.pen_up()

        ricardo.right(90)
        ricardo.forward(radius_difference)
        ricardo.left(90)
